...
import { loadHome , instantQuote ,sendQuote,userDashboard,contactUs,contactUsMail,showEnquiryCart,userLoginPage,shopOnlinePage, userLogin,aboutUs,userLogout,productDetailPage,searchProducts, allProducts,  addToEnquirySession, removeFromEnquiry,sendEnquiryEmail,getEnquiryCount, faqPage, filterByCategory, filterProducts, internationalOrders, privacyPolicy, allCategories} from "../controllers/userController.js";
...
router.get('/shoponline',shopOnlinePage)
